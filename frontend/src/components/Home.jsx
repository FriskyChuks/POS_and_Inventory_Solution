                ...
                <table className="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="src/assets/images/faces/face10.jpg" alt="image" />
                          <div className="table-user-name ml-3">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="src/assets/images/faces/face11.jpg" alt="image" />
                          <div className="table-user-name ml-3">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="src/assets/images/faces/face13.jpg" alt="image" />
                          <div className="table-user-name ml-3">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="src/assets/images/faces/face16.jpg" alt="image" />
                          <div className="table-user-name ml-3">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                <img className="survey-img mb-lg-3" src="src/assets/images/dashboard/img_3.jpg" alt="" />
                <div className="pt-2">
              ...
              <div className="d-flex flex-wrap border-bottom py-2 justify-content-between">
                <img className="survey-img mb-lg-3" src="src/assets/images/dashboard/img_1.jpg" alt="" />
                <div className="pt-2">
              ...
              <div className="d-flex flex-wrap border-bottom py-2 justify-content-between">
                <img className="survey-img mb-lg-3" src="src/assets/images/dashboard/img_2.jpg" alt="" />
                <div className="pt-2">
            ...
            <div className="card-body">
                ...
                <div className="col-12 col-sm-7">
                  <div className="row">
                    <div className="col-4 col-md-4">
                      <img className="customer-img" src="src/assets/images/faces/face22.jpg" alt="" />
                    </div>
                ...
                <div className="col-sm-7">
                  <div className="row">
                    <div className="col-4 col-sm-4">
                      <img className="customer-img" src="src/assets/images/faces/face25.jpg" alt="" />
                    </div>
              ...
              <div className="row py-1">
                <div className="col-sm-7">
                  <div className="row">
                    <div className="col-4 col-sm-4">
                      <img className="customer-img" src="src/assets/images/faces/face15.jpg" alt="" />
                    </div>
                    <div className="col-8 col-sm-8 p-sm-0">
              ...
              <div className="row py-1">
                <div className="col-sm-7">
                  <div className="row">
                    <div className="col-4 col-sm-4">
                      <img className="customer-img" src="src/assets/images/faces/face5.jpg" alt="" />
                    </div>
                    <div className="col-8 col-sm-8 p-sm-0">
              ...
              <div className="row">
                <div className="col-sm-7">
                  <div className="row">
                    <div className="col-4 col-sm-4">
                      <img className="customer-img" src="src/assets/images/faces/face2.jpg" alt="" />
                    </div>
                    <div className="col-8 col-sm-8 p-sm-0">
            ...
            <div className="card-body">
              ...
              <div className="row border-bottom pb-3 pt-4 align-items-center mx-0">
                <div className="col-sm-9 pl-0">
                  <div className="d-flex">
                    <img src="src/assets/images/dashboard/img_4.jpg" alt="" />
                    <div className="pl-2">
              ...
              <div className="row py-3 align-items-center mx-0">
                <div className="col-sm-9 pl-0">
                  <div className="d-flex">
                    <img src="src/assets/images/dashboard/img_5.jpg" alt="" />
                    <div className="pl-2">
                  ...
                  <p className="text-muted">
                    ...
                    <span className="d-inline-block">
                      <span className="d-flex d-inline-block">
                        <img className="ml-1" src="src/assets/images/faces/face1.jpg" alt="" />
                        <img className="ml-1" src="src/assets/images/faces/face10.jpg" alt="" />
                        <img className="ml-1" src="src/assets/images/faces/face14.jpg" alt="" />
                      </span>
                    </span>
                  </p>
                </li>
              ...
              <div className="list-card">
                <div className="row align-items-center">
                  <div className="col-7 col-sm-8">
                    <div className="row align-items-center">
                      <div className="col-sm-4">
                        <img src="src/assets/images/faces/face2.jpg" alt="" />
                      </div>
              ...
              <div className="list-card">
                <div className="row align-items-center">
                  <div className="col-7 col-sm-8">
                    <div className="row align-items-center">
                      <div className="col-sm-4">
                        <img src="src/assets/images/faces/face3.jpg" alt="" />
                      </div>
                      <div className="col-sm-8 pr-0 pl-sm-0">
              ...
              <div className="list-card">
                <div className="row align-items-center">
                  <div className="col-7 col-sm-8">
                    <div className="row align-items-center">
                      <div className="col-sm-4">
                        <img src="src/assets/images/faces/face11.jpg" alt="" />
                      </div>
                      <div className="col-sm-8 pr-0 pl-sm-0">
            ...
            <div className="card-body">
              ...
              <div className="row py-2">
                <div className="col-sm-12">
                  <div className="d-flex justify-content-between pb-3 border-bottom">
                    <div>
                      <img className="mr-2" src="src/assets/images/browser-logo/opera-logo.png" alt="" />
              ...
              <div className="row py-2">
                <div className="col-sm-12">
                  <div className="d-flex justify-content-between pb-3 border-bottom">
                    <div>
                      <img className="mr-2" src="src/assets/images/browser-logo/safari-logo.png" alt="" />
              ...
              <div className="row py-2">
                <div className="col-sm-12">
                  <div className="d-flex justify-content-between pb-3 border-bottom">
                    <div>
                      <img className="mr-2" src="src/assets/images/browser-logo/chrome-logo.png" alt="" />
              ...
              <div className="row py-2">
                <div className="col-sm-12">
                  <div className="d-flex justify-content-between pb-3 border-bottom">
                    <div>
                      <img className="mr-2" src="src/assets/images/browser-logo/firefox-logo.png" alt="" />
              ...
              <div className="row py-2">
                <div className="col-sm-12">
                  <div className="d-flex justify-content-between">
                    <div>
                      <img className="mr-2" src="src/assets/images/browser-logo/explorer-logo.png" alt="" />
